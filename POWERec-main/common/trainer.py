   ...
   and some other features helpful for model training and evaluation.
    ...
    def _train_epoch(self, train_data, epoch_idx, loss_func=None):
        ...
        for batch_idx, interaction in enumerate(train_data):
            ...
            # distri.append(distri_batch.detach())
            # score.append(score_batch.detach())
            # for test
            #if batch_idx == 0:
            #    break
        # distri = torch.cat(distri, 0)
        # score = torch.cat(score, 0)
        # print(distri)
        # torch.save(distri, '/home/dongxue/mmrec/distri%.1f.pt'%self.neg_weight)
        # torch.save(score, '/home/dongxue/mmrec/score%.1f.pt'%self.neg_weight)
        return total_loss
